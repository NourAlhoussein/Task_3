const members = [
  {
    photoUrl: "/Task_3/assets/images/member1.png",
    name: "Ms. Sarah Anderson",
    studying: "Qualification:Bachelor's Degree in Early Childhood Education",
    description:
  ...
  {
    photoUrl: "/Task_3/assets/images/member2.png",
    name: "Mr. David Roberts",
    studying: "Qualification: Master's Degree in Elementary Education",
    description:
  ...
  {
    photoUrl: "/Task_3/assets/images/member3.png",
    name: "Ms. Jessica Lee",
    studying: "Qualification: Master's Degree in Special Education",
    description:
  ...
  {
    photoUrl: "/Task_3/assets/images/member4.png",
    name: "Mr. Michael Turner",
    studying: "Qualification: Bachelor's Degree in Physical Education",
    description:
  ...
  {
    photoUrl: "/Task_3/assets/images/member5.png",
    name: "Ms. Emily Hernandez",
    studying: "Qualification: Diploma in Child Psychology",
    description:
  ...
  {
    photoUrl: "/Task_3/assets/images/member6.png",
    name: "Mr. David Roberts",
    studying: "Qualification: Master's Degree in Elementary Education",
    description:
      "With a strong background in elementary education, Mr. David brings a creative and interactive teaching style to his classroom. His enthusiasm for learning inspires students to ask questions and think critically.",
